...
<body>
	...
	<h1>Edit <?php echo $_SESSION["market"]?></h1>
	<div id = "product_table">
		...
		<div id = "float_form" style = "display: none;">
			Product Name: <input id = "prodname" type = "text" name = "prodname" value = <?php echo $prodname;?> > <span class = "error">* <?php echo $err;?> </span> <br>
			Quantity:  <input id = "quan" type = "number" name = "quan" min = 0 value = <?php echo $quan;?>> <span class = "error">* <?php echo $err;?> </span> <br>
			Unit:  <input id = "unit" type = "text" name = "unit" value = <?php echo $unit;?>> <span class = "error">* <?php echo $err;?> </span> <br>
			Price:  <input id = "price" type = "number" name = "price" min = 0 value = <?php echo $price;?>> <span class = "error">* <?php echo $err;?> </span> <br>
			<!--
					Kailangang nakafix position netong Save sa lower right ng page 
				-->
	...
	<button type = "button" onclick="magic()" id = "show">Add Products</button>
	<!--
