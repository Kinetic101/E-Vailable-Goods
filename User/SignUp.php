...
<header>
	...
	<div class = "login"> 
		<form method = "post" action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
			...
			E-Mail: <br>  <input type = "email" placeholder="Must not exceed 40 characters" name = "email" class = "field" value = "<?php echo $email?>"id="email" maxlength="40"> <span class = "error">* <?php echo $emailErr;?></span> <br>
